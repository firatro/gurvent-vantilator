...
{
    public class ProductModelEditViewModel
    {
        ...
        public List<ProductContentFeatureViewModel> ContentFeatures { get; set; }
            = new();
        ...
        // Yeni yüklenen dosyalar (optional)
        ...
        public List<ProductModelDocumentDto> ExistingDocuments { get; set; }
        ...
        public string? DeletedFeatureIdsString { get; set; }
