    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductUsageTypes", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "ProductWorkingConditions",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductWorkingConditions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalPressure = table.Column<double>(type: "float(10)", precision: 10, scale: 2, nullable: true),
                    TotalPressureUnit = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    ...
                    Image2Path = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    Image3Path = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    Image4Path = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    Image5Path = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    ...
                    TestDataPath = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    ScaleImagePath = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    Order = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    BodyMaterialStandard = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BodyMaterialOptional = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ImpellerMaterialStandard = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ImpellerMaterialOptional = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CarryingBracketStandard = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CarryingBracketOptional = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HeatResistanceStandard = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HeatResistanceOptional = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ColdResistanceStandard = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ColdResistanceOptional = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MotorProtectionCapStandard = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MotorProtectionCapOptional = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductModels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductModels_ProductSeries_ProductSeriesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductModelDocuments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductModelDocuments_ProductModels_ProductModelId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StandardValue = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OptionalValue = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Order = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductModelFeature", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductModelUsageType", x => new { x.ProductModelsId, x.UsageTypesId });
                    table.ForeignKey(
                        name: "FK_ProductModelUsageType_ProductModels_ProductModelsId",
                        column: x => x.ProductModelsId,
                        principalTable: "ProductModels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductModelUsageType_ProductUsageTypes_UsageTypesId",
            ...
            migrationBuilder.CreateTable(
                name: "ProductModelWorkingCondition",
                columns: table => new
                {
                    ProductModelsId = table.Column<int>(type: "int", nullable: false),
                    WorkingConditionsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductModelWorkingCondition", x => new { x.ProductModelsId, x.WorkingConditionsId });
                    table.ForeignKey(
                        name: "FK_ProductModelWorkingCondition_ProductModels_ProductModelsId",
                        column: x => x.ProductModelsId,
                        principalTable: "ProductModels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductModelWorkingCondition_ProductWorkingConditions_WorkingConditionsId",
                        column: x => x.WorkingConditionsId,
                        principalTable: "ProductWorkingConditions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductContentFeatures_ProductModels_ProductModelId",
                        column: x => x.ProductModelId,
                        principalTable: "ProductModels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ps = table.Column<double>(type: "float(10)", precision: 10, scale: 2, nullable: true),
                    Pd = table.Column<double>(type: "float(10)", precision: 10, scale: 2, nullable: true),
                    Current = table.Column<double>(type: "float(10)", precision: 10, scale: 2, nullable: true),
                    Pt = table.Column<double>(type: "float(10)", precision: 10, scale: 2, nullable: true),
                    Speed = table.Column<double>(type: "float(10)", precision: 10, scale: 2, nullable: true),
                    Q = table.Column<double>(type: "float(10)", precision: 10, scale: 2, nullable: true),
                    AirPower = table.Column<double>(type: "float(10)", precision: 10, scale: 2, nullable: true),
                    CalculatedPower = table.Column<double>(type: "float(10)", precision: 10, scale: 2, nullable: true),
                    TotalEfficiency = table.Column<double>(type: "float(5)", precision: 5, scale: 2, nullable: true),
                    MechanicalEfficiency = table.Column<double>(type: "float(5)", precision: 5, scale: 2, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ProductModelId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductTestDatas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductTestDatas_ProductModels_ProductModelId",
                        column: x => x.ProductModelId,
                        principalTable: "ProductModels",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductTestDatas_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductUsageTypeProducts", x => new { x.ProductsId, x.UsageTypesId });
                    table.ForeignKey(
                        name: "FK_ProductUsageTypeProducts_ProductUsageTypes_UsageTypesId",
                        column: x => x.UsageTypesId,
                        principalTable: "ProductUsageTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductUsageTypeProducts_Products_ProductsId",
            ...
            migrationBuilder.CreateTable(
                name: "ProductWorkingConditionProducts",
                columns: table => new
                {
                    ProductsId = table.Column<int>(type: "int", nullable: false),
                    WorkingConditionsId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductWorkingConditionProducts", x => new { x.ProductsId, x.WorkingConditionsId });
                    table.ForeignKey(
                        name: "FK_ProductWorkingConditionProducts_ProductWorkingConditions_WorkingConditionsId",
                        column: x => x.WorkingConditionsId,
                        principalTable: "ProductWorkingConditions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductWorkingConditionProducts_Products_ProductsId",
                        column: x => x.ProductsId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "ProductTestDataPoints",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductTestDataId = table.Column<int>(type: "int", nullable: false),
                    RowNumber = table.Column<int>(type: "int", nullable: false),
                    RPM = table.Column<double>(type: "float(10)", precision: 10, scale: 2, nullable: false),
                    Q1 = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Pt1 = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Q2 = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Pt2 = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Q3 = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Pt3 = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Q4 = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Pt4 = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Q5 = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Pt5 = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Q6 = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Pt6 = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Q7 = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Pt7 = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Q8 = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Pt8 = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Q9 = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Pt9 = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Q10 = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Pt10 = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Q11 = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Pt11 = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Q12 = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Pt12 = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Ps = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Pd = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    Power = table.Column<double>(type: "float(12)", precision: 12, scale: 4, nullable: true),
                    Current = table.Column<double>(type: "float(10)", precision: 10, scale: 4, nullable: true),
                    Speed = table.Column<double>(type: "float(10)", precision: 10, scale: 2, nullable: true),
                    AirPower = table.Column<double>(type: "float(14)", precision: 14, scale: 6, nullable: true),
                    TotalEfficiency = table.Column<double>(type: "float(6)", precision: 6, scale: 2, nullable: true),
                    MechanicalEfficiency = table.Column<double>(type: "float(6)", precision: 6, scale: 2, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductTestDataPoints", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductTestDataPoints_ProductTestDatas_ProductTestDataId",
                        column: x => x.ProductTestDataId,
                        principalTable: "ProductTestDatas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 8, null, null, true, 9, 8, null, null, null, null, null, "konfigurator", "Konfigüratör", "/fanselector" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductContentFeatures_ProductModelId",
                table: "ProductContentFeatures",
                column: "ProductModelId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductModelDocuments_ProductModelId",
                table: "ProductModelDocuments",
                column: "ProductModelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductModels_ProductSeriesId",
                table: "ProductModels",
                column: "ProductSeriesId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductModelUsageType_UsageTypesId",
                table: "ProductModelUsageType",
                column: "UsageTypesId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductModelWorkingCondition_WorkingConditionsId",
                table: "ProductModelWorkingCondition",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductTestDataPoints_ProductTestDataId_RowNumber",
                table: "ProductTestDataPoints",
                columns: new[] { "ProductTestDataId", "RowNumber" });

            migrationBuilder.CreateIndex(
                name: "IX_ProductTestDatas_ProductId_IsActive",
                table: "ProductTestDatas",
                columns: new[] { "ProductId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_ProductTestDatas_ProductModelId",
                table: "ProductTestDatas",
                column: "ProductModelId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductUsageTypeProducts_UsageTypesId",
                table: "ProductUsageTypeProducts",
                column: "UsageTypesId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductWorkingConditionProducts_WorkingConditionsId",
                table: "ProductWorkingConditionProducts",
                column: "WorkingConditionsId");
